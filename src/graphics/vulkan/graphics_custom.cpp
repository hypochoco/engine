//
//  graphics_texture.cpp
//  engine
//
//  Created by Daniel Cho on 12/15/25.
//

// constructors for texture to texture draws

#include "engine/graphics/graphics.h"

void Graphics::createRenderPass(VkRenderPass& renderPass,
                                VkAttachmentLoadOp loadOp) {
    
    // loadOp: VK_ATTACHMENT_LOAD_OP_CLEAR | VK_ATTACHMENT_LOAD_OP_LOAD
...
//    dependency.dstAccessMask = VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;
    ...
    // Wait for prior shader reads to finish before writing
    ...
    // Wait for writes to finish before subsequent shader reads
...
void Graphics::createFramebuffer(VkFramebuffer& frameBuffer,
...
void Graphics::createDescriptorSetLayout(VkDescriptorSetLayout& descriptorSetLayout) {
...
void Graphics::createPipeline(VkPipeline& pipeline,
    ...
    // todo: take in some kind of configuration object, consolidate with push constants
...
void Graphics::createPipeline(VkPipeline& pipeline,
                              ...
                              VkRenderPass& renderPass,
                              VkPipelineShaderStageCreateInfo* shaderStages,
                              VkPushConstantRange& pushConstantRange) { // with push constants
